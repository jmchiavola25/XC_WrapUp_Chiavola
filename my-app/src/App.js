    ...
    <div className="App">
      ...
      <div className="countriesDropDown">
        <h2>Select a Country</h2>
            ...
            select="country-list" params={["id", "code", "name"]} onSelectChange={HandleCountryChange}/>
        </div>
        ...
        <div className="statesDropDown" id="divForStates">
          ...
          <States url={selectedCountryCode} onSelectChange={HandleCountryChange}className="Select-state" id ="states" type="State"
          select="state-list"/>
        </div>
    </div>
  );
